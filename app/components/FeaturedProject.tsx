...
const FeaturedProject: React.FC<FeaturedProjectProps> = ({
  ...
  return (
    <div
      className={`flex flex-col md:flex-row items-center rounded-lg ${
        isReversed ? "md:flex-row-reverse" : ""
      }`}
    >
      <div
        className={`flex-shrink-0 mb-4 md:mb-0 w-full md:w-1/2 ${
      ...
      <div className="w-full md:w-1/2">
        <h4 className={`text-2xl font-semibold text-gray-800 mb-2 text-left`}>
          {title}
        </h4>
